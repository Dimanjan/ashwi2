  ...
  return (
    <main className="container about-page">
      <section className="about-card">
        ...
        <p>
          We offer living room furniture, wardrobes, mandir units, dressing tables, storage cabinets,
          and custom-ready pieces designed for comfort, utility, and style.
        </p>
        <p>
          We take payment only after delivery, so customers can receive and verify the product with
          confidence.
        </p>
